        ...
        return (<React.Fragment>
            {
                this.state.didGetUserName ?
                    ...
                    <Redirect to = {"/game/" + this.state.gameId}><button className="btn btn-success" style = {{marginLeft: String((window.innerWidth / 2) - 60) + "px", width: "120px"}}>Начать игру</button></Redirect>

                    :
                    <div>
                        <h1 style={{textAlign: "center", marginTop: String((window.innerHeight / 7)) + "px"}}>Регистрация:</h1>
...
const Onboard = (props) => {
    return <CreateNewUser setUserName = {props.setUserName}/>
}
